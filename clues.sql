...
SELECT language
FROM countries JOIN countrylanguages ON countries.code = countrylanguages.countrycode
WHERE countries.name LIKE '%Vatican%';
...
FROM countries JOIN countrylanguages ON countries.code = countrylanguages.countrycode
WHERE language = 'Italian' AND region = 'Southern Europe' AND name LIKE '%Vatican%';
...
SELECT cities.name, countries.name
FROM cities JOIN countries ON cities.countrycode = countries.code
WHERE countries.name = 'Brazil' AND cities.id = countries.capital;
